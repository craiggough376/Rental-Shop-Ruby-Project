...
game11 = Game.new({"title" => "Portal 2", "console" => "PC", "genre" => "Puzzle", "quantity" => 5, "image" => "/images/portal2.jpg"})
game1.save()
game2.save()
game3.save()
game4.save()
...
rental16 = Rental.new({"customer_id" => customer5.id, "game_id" => game11.id, "rental_period" => 7, "rental_status" => "Returned", "date_rented" => "2019/05/15"})
rental17 = Rental.new({"customer_id" => customer3.id, "game_id" => game11.id, "rental_period" => 7, "rental_status" => "Renting", "date_rented" => "2019/05/15"})
rental1.save()
rental2.save()
rental3.save()
rental4.save()

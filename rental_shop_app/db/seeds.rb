...
game4 = Game.new({"title" => "Call Of Duty Black Ops 4", "console" => "PS4", "genre" => "FPS", "quantity" => 10, "image" => "/images/godofwar.jpg"})
...
game9 = Game.new({"title" => "Fifa 19", "console" => "PS4", "genre" => "Sports", "quantity" => 10, "image" => "/images/fifa19.jpg"})
game10 = Game.new({"title" => "GTA V", "console" => "PS4", "genre" => "RPG", "quantity" => 10, "image" => "/images/gtav.jpg"})
game1.save()
game2.save()
game3.save()
game4.save()
